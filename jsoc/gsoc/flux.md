...
Recent advances in reinforcement learning led to many breakthroughs in artifical intelligence. Some of the latest deep reinforcement learning algorithms are already implemented in [ReinforcementLearning.jl](https://github.com/JuliaReinforcementLearning/ReinforcementLearning.jl) with Flux. We'd like to have more interesting and practical algorithms added to enrich the whole community, including but not limited to the following directions:
